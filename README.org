...
- The install will create an example makefile, the commands /make all/, /make run1/ and /make run2/ are the important ones. Simply copy this makefile to your .f90 file and run said commands depending on your plotting needs
